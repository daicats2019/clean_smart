...
class NoPhones extends StatefulWidget {
  const NoPhones({Key? key}) : super(key: key);

  @override
  State<NoPhones> createState() => _NoPhonesState();
}

class _NoPhonesState extends State<NoPhones> {
  bool _ischeck = false;
