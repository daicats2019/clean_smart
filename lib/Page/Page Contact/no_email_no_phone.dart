...
class NoEmailNoPhone extends StatefulWidget {
  const NoEmailNoPhone({Key? key}) : super(key: key);

  @override
  State<NoEmailNoPhone> createState() => _NoEmailNoPhoneState();
}

class _NoEmailNoPhoneState extends State<NoEmailNoPhone> {
  bool _ischeck = false;
  @override
