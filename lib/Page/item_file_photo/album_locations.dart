...
class AlbumLocations extends StatefulWidget {
  const AlbumLocations({Key? key}) : super(key: key);

  @override
  State<AlbumLocations> createState() => _AlbumLocationsState();
}

class _AlbumLocationsState extends State<AlbumLocations> {
  bool _ischeck = false;
