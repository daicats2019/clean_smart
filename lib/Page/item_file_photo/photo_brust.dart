...
class PhotoBrust extends StatefulWidget {
  const PhotoBrust({Key? key}) : super(key: key);

  @override
  State<PhotoBrust> createState() => _PhotoBrustState();
}

class _PhotoBrustState extends State<PhotoBrust> {
  bool _ischeck = false;
  @override
